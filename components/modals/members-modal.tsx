...
import type { SerializedServer, SerializedMember } from "@/types";
...
type ServerWithSerializedMembers = SerializedServer & {
...
export const MembersModal = () => {
  ...
  const { server } = data as { server: ServerWithSerializedMembers };
